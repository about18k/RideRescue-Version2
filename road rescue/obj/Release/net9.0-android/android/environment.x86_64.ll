...
@aot_dso_cache = dso_local local_unnamed_addr global [792 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.67_name, ; name: libaot-System.IO.Pipelines.dll.so
		ptr null; void* handle
	}, ; 4
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x21a166c44b52198c, ; from name: road rescue.so
		i64 u0xafd2586c69cc88c2, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-road rescue.dll.so
		ptr null; void* handle
	}, ; 104
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x48b8d4e681a83687, ; from name: road rescue
		i64 u0xafd2586c69cc88c2, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-road rescue.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x497fd75ba0b8c0bf, ; from name: aot-road rescue.so
		i64 u0xafd2586c69cc88c2, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-road rescue.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x520ca6c609a0c43d, ; from name: road rescue.dll.so
		i64 u0xafd2586c69cc88c2, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-road rescue.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x79b1fe042f27d055, ; from name: aot-road rescue.dll.so
		i64 u0xafd2586c69cc88c2, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-road rescue.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xafd2586c69cc88c2, ; from name: libaot-road rescue.dll.so
		i64 u0xafd2586c69cc88c2, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-road rescue.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xbc2fc184abf45f0c, ; from name: libaot-road rescue
		i64 u0xafd2586c69cc88c2, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-road rescue.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xce7ff7d474a0fb1a, ; from name: aot-road rescue
		i64 u0xafd2586c69cc88c2, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-road rescue.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xd4c9c1dff69a8182, ; from name: libaot-road rescue.so
		i64 u0xafd2586c69cc88c2, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-road rescue.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [27 x i8] c"com.companyname.roadrescue\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [26 x i8] c"libaot-road rescue.dll.so\00", align 16
...
@.DSOCacheEntry.67_name = private unnamed_addr constant [34 x i8] c"libaot-System.IO.Pipelines.dll.so\00", align 16
